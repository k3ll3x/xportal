...
public class PantallPause implements Screen {
    ...
    public PantallPause(Juego juego) {
        this.juego = juego;
    }
    ...
    public void create(){
        ...
        btnBack.setPosition(ancho / 2 - btnBack.getWidth()/ 2+100, 0.428f * alto-50);
        ...
        btnPlay.setPosition(ancho / 2 - btnPlay.getWidth()/ 2-50, 0.428f * alto-50);
        ...
        btnPlay.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y){
                Gdx.app.log("clicked", "TAP sobre el boton Play");
    ...
    private void cargarTexturas() {
        ...
        texturaFondo = assetManager.get("NivelPausa.png");
        texturaBtnPlay = assetManager.get("BtmPlay.png");
