...
import mx.videojuegos.izo.MenuPrincipal;
...
public class PrincipalPantalla implements Screen {
    ...
    public PrincipalPantalla(Juego juego) {
        this.juego = juego;
    }
    ...
    private void cargarTexturas() {
        ...
        texturaFondo = assetManager.get("Izo.jpg");

        //Textura botones
        texturaBtnBack = assetManager.get("Izo.jpg");
